...
![img](../../assets/20200103213149526.png)
...
![在这里插入图片描述](../../assets/2020031416414486.jpeg)
...
![img](../../assets/20200103213220764.png)
...
![img](../../assets/20200103213726902.png)

虚拟机遇到一条 new 指令时，先检查常量池是否已经加载相应的类，如果没有，必须先执行相应的类加载。类加载通过后，接下来分配内存。若 Java 堆中内存是绝对规整的，使用 “指针碰撞 “方式分配内存；如果不是规整的，就从空闲列表中分配，叫做” 空闲列表 “方式。划分内存时还需要考虑一个问题 - 并发，也有两种方式: CAS 同步处理，或者本地线程分配缓冲 (Thread Local Allocation Buffer, TLAB)。然后内存空间初始化操作，接着是做一些必要的对象设置 (元信息、哈希码…)，最后执行 `` 方法。
...
![内存分配的两种方式](../../assets/20200103213812259.png)
...
![内存分配时保证线程安全的两种方式](../../assets/20200103213833317.png)
...
![img](../../assets/20200103213926911.png)
...
![img](../../assets/20200103213948956.png)
...
![img](../../assets/20200104115917418.png)
...
![img](../../assets/20200104115940771.png)
...
![img](../../assets/20200104120144820.png)
...
![img](../../assets/20200104165551656.png)
